  ...
  return (
    <form className="login-form" onSubmit={handleSubmit}>
      ...
      <div className="form-outline mb-3">
        ...
        <input type="file" multiple name="image" onChange={handleUploadFile} />
      </div>

      {/* <!-- Submit button --> */}
      <button className="btn btn-primary btn-block mb-4">Add Book </button>

      {uploadPic && (
        <p className="alert alert-success py-2">Adding book, please wait </p>
      )}
